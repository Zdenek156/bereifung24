          ...
          {services.map((service) => (
            <button
              ...
              className={`
                ...
                ${service.available 
                  ? 'border-gray-200 dark:border-gray-700 hover:border-primary-500 dark:hover:border-primary-400 hover:shadow-md hover:scale-105 cursor-pointer' 
              ...
              <div className="flex flex-col items-center text-center">
                ...
                {service.available && (
                  <div className="mt-auto pt-1">
                    <div className="inline-flex items-center gap-2 text-primary-600 dark:text-primary-400 font-medium group-hover:gap-3 transition-all">
                      Anfrage erstellen
