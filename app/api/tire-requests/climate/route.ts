  ...
  try {
      ...
      try {
        await sendEmail({
          ...
          html: `
            ...
            <p>Es gibt eine neue Klimaservice-Anfrage in Ihrer Nähe.</p>
    ...
    try {
      ...
      await sendEmail({
        ...
        subject: 'Ihre Anfrage für Klimaanlagen-Service wurde erstellt',
        html: `
          <!DOCTYPE html>
          <html>
          <head>
          ...
          <body>
            <div class="container">
              ...
              <div class="content">
                ...
                <p>Vielen Dank für Ihre Klimaanlagen-Service Anfrage! Wir haben Werkstätten in Ihrer Nähe informiert.</p>
                
                <div class="highlight">
                  <h3 style="margin-top: 0;">📋 Ihre Anfrage im Überblick:</h3>
                  <ul style="list-style: none; padding-left: 0;">
                    <li><strong>Service:</strong> ${serviceTypeLabels[validatedData.serviceType]}</li>
                    ${vehicleInfo !== 'Nicht angegeben' ? `<li><strong>Fahrzeug:</strong> ${vehicleInfo}</li>` : ''}
                    ${validatedData.vin ? `<li><strong>FIN:</strong> ${validatedData.vin}</li>` : ''}
