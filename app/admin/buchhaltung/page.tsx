        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Datenexport</h3>
              <p className="text-sm text-gray-600 mb-4">DATEV, Excel oder PDF exportieren</p>
              <div className="text-primary-600 font-medium">Exportieren →</div>
            </Link>
            ...
            >
              ...
              <p className="text-sm text-gray-600 mb-4">BWA, EÜR und Reports</p>
