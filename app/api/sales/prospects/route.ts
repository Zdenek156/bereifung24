      ...
      try {
        ...
        const newProspect = await prisma.prospectWorkshop.create({
          data: {
            ...
            latitude: prospect.latitude ?? prospect.lat ?? 0,
            longitude: prospect.longitude ?? prospect.lng ?? 0,
            phone: prospect.phone || null,
            website: prospect.website || null,
            rating: prospect.rating || null,
            reviewCount: prospect.reviewCount || 0,
            photoUrls: Array.isArray(prospect.photoUrls) ? prospect.photoUrls : [],
            placeTypes: Array.isArray(prospect.placeTypes) ? prospect.placeTypes : [],
