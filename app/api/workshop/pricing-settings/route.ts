...
const pricingSettingsSchema = z.object({
  ...
  batteryManualPricing: z.boolean(),
  batteryFixedMarkup: z.number().min(0),
  batteryPercentMarkup: z.number().min(0).max(100),
  batteryIncludeVat: z.boolean(),
  brakeManualPricing: z.boolean(),
