/**
 * Update Invoice Email Template - Umstellung auf Stripe Automatik-Abzug
 * 
 * Ändert das monatliche Rechnungs-Email-Template:
 * - Entfernt ALLE Zahlungshinweise (SEPA, Überweisung)
 * - Erklärt, dass Provision bereits automatisch von Stripe abgezogen wurde
 * - Reine Info-Rechnung für Buchhaltungszwecke
 * 
...
async function updateInvoiceEmailTemplate() {
  try {
    console.log('🔄 Aktualisiere Invoice Email Template für Stripe-Automatik...')

    // Neues HTML - nur Information, keine Zahlungsaufforderung
...
<body>
  <div class="container">
    ...
    // Aktualisierte Platzhalter (sepaReference und commissionItems entfernt - Details nur in PDF)
    ...
    console.log('   ✓ Alle Zahlungshinweise entfernt')
    console.log('   ✓ Info-Text: "Provision bereits automatisch über Stripe abgezogen"')
    console.log('   ✓ Betreff geändert: "Provisionsabrechnung" statt "Provisionsrechnung"')
    console.log('   ✓ Detaillierte Provisionsauflistung entfernt (nur in PDF)')
    console.log('   ✓ E-Mail übersichtlich und informativ gestaltet')
    console.log('   ✓ Hinweis auf eRechnung im Anhang')
