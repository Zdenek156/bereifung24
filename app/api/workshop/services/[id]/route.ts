  ...
  try {
    ...
    const updatedService = await prisma.workshopService.update({
      ...
      data: {
        ...
        washingPrice: washingPrice !== undefined ? (washingPrice ? parseFloat(washingPrice) : null) : undefined,
        refrigerantPricePer100ml: refrigerantPrice !== undefined ? (refrigerantPrice ? parseFloat(refrigerantPrice) : null) : undefined,
        acceptsMountingOnly: acceptsMountingOnly !== undefined ? acceptsMountingOnly : undefined,
        mountingOnlySurcharge: mountingOnlySurcharge !== undefined ? (mountingOnlySurcharge !== null ? parseFloat(mountingOnlySurcharge) : 0) : undefined,
        ...
        washingAvailable: washingAvailable !== undefined ? washingAvailable : undefined,
