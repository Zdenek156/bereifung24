    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between py-4">
              ...
              <div className="flex gap-1.5 sm:gap-3">
                <Link
                  href="/login"
                  className="px-2.5 sm:px-5 py-2.5 text-xs sm:text-sm font-medium hover:bg-white/10 rounded-lg transition-colors"
                >
                  Anmelden
                </Link>
                <Link
                  href="/register/customer"
                  className="px-2.5 sm:px-5 py-2.5 text-xs sm:text-sm font-medium bg-white text-primary-600 rounded-lg hover:bg-primary-50 transition-all shadow-lg hover:shadow-xl transform hover:scale-105 whitespace-nowrap"
                >
      ...
      <section id="services" className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-4">
              Alle Reifenservices an einem Ort
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Von Reifenwechsel bis Klimaservice – wir decken alle Serviceleistungen ab
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
            {allServices.map((service, index) => (
              <div key={index} className="bg-white p-6 rounded-xl border border-gray-200 hover:border-primary-300 hover:shadow-lg transition-all">
              ...
              <div className="bg-gradient-to-br from-green-50 to-green-100 p-8 rounded-2xl">
                <div className="bg-white p-6 rounded-xl shadow-lg mb-4">
                  ...
                  <p className="text-gray-600 italic">
                    "Endlich eine Plattform, die den Reifenwechsel transparent und einfach macht. Habe 3 Angebote bekommen und 150 CHF gespart!"
                  </p>
                </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-lg">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Basel</p>
                    </div>
                  </div>
                  <div className="flex gap-1 mb-2">
                    {[...Array(5)].map((_, i) => (
                  ...
                  <p className="text-gray-600 italic">
                    "Super schnell und unkompliziert. Innerhalb von 2 Stunden hatte ich 5 Angebote. Die Online-Terminbuchung ist genial!"
                  </p>
                </div>
              </div>
            </div>
