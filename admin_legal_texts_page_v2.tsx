...
import { ArrowLeft, Save, FileText, Shield, Scale, Eye, Loader2, Code } from 'lucide-react'
    ...
    <div className="flex flex-wrap items-center gap-0.5 p-2 border-b border-gray-200 bg-gray-50/50">
      ...
      {editor.isActive('link') && (
        <button
          ...
          className="p-1.5 rounded text-sm text-red-500 hover:bg-red-50"
      ...
      <button
        ...
        className="p-1.5 rounded text-sm text-gray-600 hover:bg-gray-100 disabled:opacity-30"
...
export default function LegalTextsPage() {
  ...
  // When switching from HTML source back to editor, sync content
  const toggleHtmlMode = () => {
    if (showHtml) {
      // Was in HTML mode, switching back to WYSIWYG
