...
export default function CustomerSettings() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-5">
      {/* Header */}
      <div className="mb-5">
        <h1 className="text-xl font-bold text-gray-900 dark:text-white">Persönliche Daten & Einstellungen</h1>
        <p className="text-xs text-gray-500 dark:text-gray-400">Ihre Daten für die Rechnungsstellung</p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-5 transition-colors">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          {/* Display Settings */}
          <div>
            <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-3">Darstellung</h3>
            <label className="flex items-center justify-between cursor-pointer p-3 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-5">
            <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-3">Kundenart</h3>
            <div className="flex gap-5">
              <label className="flex items-center cursor-pointer">
                ...
                />
                <span className="ml-2 text-sm text-gray-700 dark:text-gray-300">Privatkunde</span>
              </label>
              <label className="flex items-center cursor-pointer">
                <input
                  type="radio"
                  ...
                  className="w-3.5 h-3.5 text-primary-600 focus:ring-primary-500"
                />
                <span className="ml-2 text-sm text-gray-700 dark:text-gray-300">Gewerblicher Kunde</span>
              </label>
            </div>
          </div>
          ...
          {formData.customerType === 'BUSINESS' && (
            <div className="border-t border-gray-200 dark:border-gray-700 pt-5">
              <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-3">Firmendaten</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-1.5 text-sm border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-1 focus:ring-primary-500 focus:border-primary-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-5">
            <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-3">Persönliche Daten</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">
              ...
              <div>
                ...
                <input
                  ...
                  disabled
                  className="w-full px-3 py-1.5 text-sm border border-gray-200 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-500 dark:text-gray-400"
                />
                <p className="mt-0.5 text-[11px] text-gray-400">E-Mail kann nicht geändert werden</p>
              </div>
              <div>
                <label className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">
          ...
          {/* Address */}
          <div className="border-t border-gray-200 dark:border-gray-700 pt-5">
            <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-3">Adresse</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="md:col-span-2">
                <label className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">
          ...
          {/* Quick Links */}
          <div className="border-t border-gray-200 dark:border-gray-700 pt-5">
            <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-3">Weitere Einstellungen</h3>
            <Link
              href="/dashboard/customer/weather-alert"
              className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors group border border-gray-200 dark:border-gray-700"
            >
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <div className="text-xs font-medium text-gray-900 dark:text-white">Wetter-Erinnerung</div>
                  <div className="text-[11px] text-gray-500 dark:text-gray-400">Reifenwechsel-Benachrichtigungen bei Temperaturänderungen</div>
                </div>
              </div>
          ...
          <div className="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-lg p-3">
            <div className="flex gap-2">
              ...
              <div className="text-xs text-blue-800 dark:text-blue-300">
                <p className="font-medium mb-0.5">Wichtig für die Rechnungsstellung</p>
          ...
          {/* Submit Button */}
          <div className="flex gap-3 justify-end border-t border-gray-200 dark:border-gray-700 pt-5">
            <Link
              href="/dashboard/customer"
              className="px-4 py-1.5 text-sm border border-gray-200 dark:border-gray-600 text-gray-600 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
            >
              Abbrechen
            </Link>
            <button
        ...
        <div className="mt-8 pt-5 border-t border-red-200 dark:border-red-800">
          <h3 className="text-sm font-semibold text-red-900 dark:text-red-400 mb-1">Gefahrenzone</h3>
          ...
          <div className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h4 className="text-sm font-semibold text-red-900 dark:text-red-400 mb-1">Account endgültig löschen</h4>
                ...
                <button
                  ...
                  disabled={deleting}
                  className="px-3 py-1.5 text-xs bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors disabled:opacity-50 font-medium"
                >
