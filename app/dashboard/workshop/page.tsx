  ...
  return (
    <div className="p-4">
        ...
        {sections.map((section) => {
          ...
          return (
            <div key={section.id} className={`bg-white rounded-lg shadow ${colorClasses.hover} transition-all`}>
              <Link href={section.path} className="block p-3">
                <div className="flex items-start">
                  <div className={`flex-shrink-0 w-10 h-10 ${colorClasses.bg} rounded-lg flex items-center justify-center ${colorClasses.text}`}>
                    {section.icon}
                  </div>
                  <div className="ml-3 flex-1">
                    <h3 className="text-base font-semibold text-gray-900 mb-0.5">{section.title}</h3>
      ...
      <div className="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-3">
        <h3 className="text-sm font-semibold text-blue-900 mb-1">Hilfe benötigt?</h3>
        ...
        <div className="flex gap-3">
          ...
          <a href="/faq" className="text-xs text-blue-600 hover:text-blue-800 font-medium">
            FAQ ansehen →
          </a>
        </div>
      </div>
