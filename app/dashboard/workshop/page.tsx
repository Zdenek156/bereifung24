      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Services verwalten</h3>
            <p className="text-sm text-gray-600 mb-4">Preise, Dauer und Optionen festlegen</p>
            <Link
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Urlaubsplanung</h3>
            <p className="text-sm text-gray-600 mb-4">Betriebsurlaub und Abwesenheiten</p>
            <Link
              href="/dashboard/workshop/vacations"
              className="block w-full py-2 px-4 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300 transition-colors text-center"
            >
              Urlaube verwalten
            </Link>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Preiskalkulation</h3>
            <p className="text-sm text-gray-600 mb-4">Automatische Reifenpreis-Berechnung</p>
            <Link
              href="/dashboard/workshop/pricing"
              className="block w-full py-2 px-4 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300 transition-colors text-center"
            >
              Kalkulation einrichten
            </Link>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-sm text-gray-600 mb-4">Eigene Webseite für SEO & Marketing</p>
            <Link
              href="/dashboard/workshop/landing-page"
              className="block w-full py-2 px-4 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-lg hover:from-pink-600 hover:to-purple-700 transition-colors text-center"
            >
              Page erstellen
            </Link>
          </div>
