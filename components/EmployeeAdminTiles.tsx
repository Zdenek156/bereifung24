...
const allAdminItems: AdminNavigationItem[] = [
  ...
  },
  {
    ...
    title: 'Buchhaltung',
    description: 'Finanzen, Bilanz & GuV',
    color: 'bg-lime-100',
  ...
  },
  {
    href: '/admin/hr',
    title: 'HR Management',
    description: 'Personal, Gehälter & Genehmigungen',
    color: 'bg-indigo-100',
    textColor: 'text-indigo-600',
    resource: 'hr',
    icon: (
  ...
  {
    href: '/admin/influencer-management',
    title: 'Influencer-Verwaltung',
    description: 'Influencer & Partner verwalten',
    color: 'bg-fuchsia-100',
    textColor: 'text-fuchsia-600',
    resource: 'influencer-management',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
      </svg>
  ...
  },
  {
    ...
    title: 'Influencer-Bewerbungen',
    description: 'Neue Bewerbungen prüfen',
    color: 'bg-violet-100',
    textColor: 'text-violet-600',
    resource: 'influencer-applications',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    href: '/admin/influencer-payments',
    title: 'Influencer-Auszahlungen',
    description: 'Provisionen & Zahlungen',
    color: 'bg-rose-100',
    textColor: 'text-rose-600',
    resource: 'influencer-payments',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Gesperrte E-Mail-Adressen',
    color: 'bg-slate-100',
    textColor: 'text-slate-600',
    resource: 'email-blacklist',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
