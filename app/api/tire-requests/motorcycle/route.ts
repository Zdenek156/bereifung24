...
const motorcycleRequestSchema = z.object({
  ...
  mountOnMotorcycle: z.boolean().default(false),
  ...
  try {
    ...
    const tireRequest = await prisma.tireRequest.create({
      data: {
        ...
        mountOnMotorcycle: validatedData.mountOnMotorcycle,
        additionalNotes: [
          '🏍️ MOTORRADREIFEN',
          ...
          '',
          validatedData.mountOnMotorcycle ? '⚠️ MONTAGE AM GANZEN MOTORRAD ERFORDERLICH' : '✓ Standard: Nur Räder/Felgen (ohne Motorrad)',
          '',
    ...
    try {
      ...
      await sendEmail({
        ...
        subject: 'Ihre Anfrage für Motorradreifen wurde erstellt',
        html: `
          <!DOCTYPE html>
          <html>
          <head>
          ...
          <body>
            <div class="container">
              ...
              <div class="content">
                ...
                <p>Vielen Dank für Ihre Motorradreifen-Anfrage! Wir haben Werkstätten in Ihrer Nähe informiert.</p>
                ...
                <div class="highlight">
                  ...
                  <ul style="list-style: none; padding-left: 0;">
                    ...
                    ${validatedData.tireType ? `<li><strong>Kategorie:</strong> ${tireTypeLabels[validatedData.tireType]}</li>` : ''}
                    ${validatedData.needsFrontTire && validatedData.frontTire ? `<li><strong>Vorderreifen:</strong> ${validatedData.frontTire.width}/${validatedData.frontTire.aspectRatio} R${validatedData.frontTire.diameter}</li>` : ''}
                    ${validatedData.needsRearTire && validatedData.rearTire ? `<li><strong>Hinterreifen:</strong> ${validatedData.rearTire.width}/${validatedData.rearTire.aspectRatio} R${validatedData.rearTire.diameter}</li>` : ''}
                    ${validatedData.mountOnMotorcycle ? '<li><strong>Montage:</strong> Auf Motorrad montieren</li>' : '<li><strong>Montage:</strong> Nur Reifenwechsel (Kunde bringt Räder)</li>'}
