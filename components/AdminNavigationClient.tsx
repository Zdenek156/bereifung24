...
const allNavigationItems: NavigationItem[] = [
  ...
  },
  {
    ...
    title: 'Buchhaltung',
    description: 'SKR04 Kontenplan, Journalbuch & Auswertungen',
    color: 'bg-blue-100',
    textColor: 'text-primary-600',
    resource: 'accounting',
    highlight: true,
  ...
  },
  {
    href: '/admin/hr',
    title: 'HR Management',
    description: 'Mitarbeiter, Gehälter, Verträge & Recruiting',
    color: 'bg-indigo-100',
    textColor: 'text-primary-600',
    resource: 'hr',
    highlight: true,
  ...
  },
  {
    ...
    description: 'Affiliate-Links, Tracking und Provisionen',
    color: 'bg-pink-100',
    textColor: 'text-primary-600',
  ...
  },
  {
    ...
    description: 'Auszahlungsanfragen prüfen und bearbeiten',
    color: 'bg-yellow-100',
    textColor: 'text-primary-600',
    resource: 'influencers',
    highlight: true,
  ...
  },
  {
    ...
    description: 'Bedarfsanforderungen, Bestellungen & AfA verwalten',
