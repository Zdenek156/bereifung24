...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background: white; padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 10px 10px;">
    ...
    <divplaceholders: JSON.stringify([
          { key: 'workshopName', description: 'Name der Werkstatt' },
          { key: 'customerName', description: 'Name des Kunden' },
          { key: 'customerEmail', description: 'Email des Kunden' },
          { key: 'customerPhone', description: 'Telefon des Kunden' },
    ...
    console.log('\n📝 Verwendung:')
    console.log('   - Wenn Workshop autoOrder = true hat, verwende: BOOKING_CONFIRMATION_WORKSHOP_AUTO_ORDER')
    console.log('   - Wenn Workshop autoOrder = false hat, verwende: BOOKING_CONFIRMATION_WORKSHOP
    </div>
