        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          {activeTab === 'seo' && (
            <div className="space-y-6">
              <div>
                <h2 className="text-xl font-bold text-gray-900 mb-4">SEO-Einstellungen</h2>
              ...
              <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <h3 className="font-semibold text-blue-900 mb-2">💡 SEO-Tipps</h3>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="mt-2 p-6 border-2 border-dashed border-gray-300 rounded-lg text-center">
                  ...
                  <p className="mt-2 text-sm text-gray-600">Bild-Upload folgt in Kürze</p>
                </div>
              </div>
            </div>
          )}
          ...
          {activeTab === 'about' && (
            <div className="space-y-6">
              ...
              <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                <h3 className="font-semibold text-green-900 mb-2">✍️ Schreib-Tipps</h3>
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={feature.key} className="flex items-start p-4 border border-gray-200 rounded-lg hover:border-purple-300 transition-colors">
                    <input
                      type="checkbox"
          ...
          {activeTab === 'design' && (
            <div className="space-y-6">
              ...
              <div className="p-6 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg border border-gray-200">
                <h3 className="font-semibold text-gray-900 mb-3">Farbvorschau</h3>
