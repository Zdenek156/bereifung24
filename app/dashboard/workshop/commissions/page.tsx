      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {commissionsData && (
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <p className="text-sm text-gray-600 mb-1">In Rechnung gestellt</p>
              <p className="text-2xl font-bold text-blue-600">
                {commissionsData.summary.totalBilled.toFixed(2)} €
              </p>
            </div>
            <div className="bg-white rounded-lg shadow p-6">
              <p className="text-sm text-gray-600 mb-1">Eingezogen</p>
        ...
        {filteredCommissions.length === 0 ? (
          <div className="bg-white rounded-lg shadow p-12 text-center">
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900">Keine Provisionen</h3>
