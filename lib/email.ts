      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="${process.env.NEXTAUTH_URL || 'https://bereifung24.de'}" class="button">
              Jetzt Reifen finden
            </a>
          </div>
        ...
        <div class="footer">
          ...
          <p style="margin-top: 10px;">
            <a href="${process.env.NEXTAUTH_URL || 'https://bereifung24.de'}" style="color: #0ea5e9;">bereifung24.de</a>
          </p>
        </div>
      </div>
    </body>
  ...
  return `
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          <p><strong>Hallo ${data.firstName} ${data.lastName},</strong></p>
        ...
        <div class="footer">
          ...
          <p style="margin-top: 10px;"><a href="${process.env.NEXTAUTH_URL || 'https://bereifung24.de'}" style="color: #0ea5e9;">bereifung24.de</a></p>
        </div>
      </div>
    </body>
    </html>
      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="success">
            ...
            Ihre Werkstatt <strong>${data.companyName}</strong> wurde erfolgreich verifiziert und ist ab sofort auf Bereifung24 sichtbar!
          </div>
      ...
      <div class="container" style="max-width: 600px; margin: 0 auto; padding: 20px; background: #f9fafb;">
        ...
        <div class="content">
          ...
          <div class="section">
            ...
            ${(data.serviceType === 'TIRE_CHANGE' && !data.totalTirePurchasePrice) ? `
            <div class="detail-row">
              <span class="detail-label">Montage:</span>
              <span class="detail-value">${(data.basePrice + (data.mountingOnlySurcharge || 0)).toFixed(2)}€</span>
            </div>
            ` : `
            <div class="detail-row">
